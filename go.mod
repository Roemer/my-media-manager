module my-media-manager

go 1.21.6

require (
	fyne.io/fyne/v2 v2.4.3
	github.com/roemer/gotaskr v0.3.15
)
...
require (
	...
	github.com/jfrog/build-info-go v1.9.13 // indirect
	github.com/jfrog/gofrog v1.3.1 // indirect
	github.com/jfrog/jfrog-client-go v1.34.3 // indirect
